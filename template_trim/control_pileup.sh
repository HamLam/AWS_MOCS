...
bwacommand="bwa mem -M -t 16 $BWA_DB $c_S1_R1 $c_S1_R2 | samtools view -q 10 -bS - > c_bwa.bam"
btcommand="bowtie2 -p 16 -k 5 -x $BOWTIE2_DB -1 $c_S1_R1 -2 $c_S1_R2 | samtools view -q 10 -bS - > c_bowtie2.bam"
...
cat ${WORKING_PATH}/indexcommands | parallel -j +0
