...
grep "mysqlimport" $working_dir/completed.txt > /dev/null 2>&1
 ...
 echo "Run mysqlimport"
     ...
     mysqlimport --local --socket=$BASE/thesock -u root cnv6 --use-threads=24 cnv_control_name_bwa_pileup_no_dup.chr*_t cnv_control_name_bwa_pileup.chr*_t cnv_control_name_bowtie_pileup.chr*_t cnv_sample_name_bwa_pileup_no_dup.chr*_t cnv_sample_name_bwa_pileup.chr*_t cnv_sample_name_bowtie_pileup.chr*_t
